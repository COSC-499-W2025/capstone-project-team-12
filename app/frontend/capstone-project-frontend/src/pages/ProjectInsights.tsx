...
const MOCK_PROJECTS: Project[] = [
  {
    ...
    technologies: [{ name: "Python", uses: 28 }, { name: "FastAPI", uses: 20 }, { name: "PostgreSQL", uses: 18 }, { name: "Docker", uses: 12 }, { name: "Flask", uses: 10 }],
  ...
  },
  {
    ...
    technologies: [{ name: "React", uses: 24 }, { name: "TypeScript", uses: 20 }, { name: "Tailwind CSS", uses: 16 }, { name: "Vite", uses: 14 }],
