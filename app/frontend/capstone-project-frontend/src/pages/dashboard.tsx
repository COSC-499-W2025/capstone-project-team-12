...
export function EmptyState({ onNew }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-slate-400 mb-5">Run your first analysis to get tailored insights, a résumé, and more.</p>
      <button
        onClick={onNew}
...
export default function Dashboard() {
  ...
  const handleViewResume    = (a: Analysis) => showToast(`Navigating to résumé for "${a.label}"…`);
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            {(
              [
                ...
                { label: "Résumés",    value: totalResumes,    icon: "📄" },
