...
class RepositoryProcessor:
    ...
    def process_repositories(self, repo_nodes: List[Node]) -> List[Dict[str, Any]]:
        ...
        # This will be put into JSON format to be returned, I was hung up on how to best structure that but wanted to ensure the core functionality was here
        # TODO: Update this implementation to return JSON formatted data
        processed_data: List[Dict[str, Any]] = []
        try:
            for repo_node in repo_nodes:
                git_folder_path = self._extract_git_folder(repo_node) # This path is to the temporary .git folder

                #TODO: Define _analyze_repository to extract relevant data using PyDriller
                analysis: Dict[str, Any] = self._analyze_repository(repo_node, git_folder_path)
    ...
    def _extract_git_folder(self, repo_node: Node) -> Path:
        ...
        self._rebuild_git_structure(git_node, git_path)
